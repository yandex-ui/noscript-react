...
ns.Model._getKeyParams = function(id, params, info) {
    ...
    if (typeof info.paramsRewrite === 'function') {
...
ns.Model.traverse = function(id, callback) {
    ...
    ns.assert((typeof callback === 'function'), 'ns.Model.traverse', 'callback must be a function');
...
ns.ModelUniq.prototype._init = function(id) {
    ...
    var cb = function() {
        ...
        uniq.forEach(function(i, v) {
            that.uniqCached[v] = true;
        });
    };
