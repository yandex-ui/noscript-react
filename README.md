...
Создаст реакт-элементы для указанных реактивных вьюшек, если они есть среди активных потомков текущей вьюшки. Позволяет передать `props` для создаваемых реакт-элементов.
