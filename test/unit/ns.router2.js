...
describe('router: new route parsing method', function() {
    ...
    describe('parse parameter', function() {
        ...
        Object.keys(_tests).forEach(function(test) {
            it(test, function() {
                var result = _tests[test];
                if (result.throw) {
                    expect(function() {
                        ns.router._parseParam(test);
                    }).to.throw(result.throw);
                } else {
    ...
    describe('generate parameter regexp', function() {
        ...
        Object.keys(_tests).forEach(function(test) {
            it(test, function() {
                ...
                if (result.throw) {
                    expect(function() {
                        ns.router._generateParamRegexp(ns.router._parseParam(test));
                    }).to.throw(result.throw);
                } else {
        ...
        Object.keys(_tests).forEach(function(key) {
            ...
            it(test.name, function() {
                if (test.result.throw) {
                    expect(function() {
                        ns.router.generateUrl(test.id, test.params);
                    }).to.throw(test.result.throw);
                } else {
